...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <header>
      ...
      <nav>
        <ul class="menu">
          ...
          <li><a class="actual_link" href="{{ route('issues.index')}}">Tareas</a></li>
    ...
    <section class="wrap">
      ...
      <div class="crear">
        <a href="{{ route('issues.create') }}"><button>Crear Tarea</button></a>
      </div>
      @foreach ($issues as $issue)
          <section class="card">
              <h2><a href="/issues/{{ $issue->id }}">{{ $issue['name'] }}</a></h2>
              <a href="{{ route('issues.edit', $issue)}}">Editar</a>
